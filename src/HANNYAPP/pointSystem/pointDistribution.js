...
import {POINT_DISTRIBUTION} from "../../components/graphql/queries";
...
function PointDistribution({search,addModify}) {
    ...
    const { loading, error, data,refetch } = useQuery(POINT_DISTRIBUTION);
    ...
    console.log({[item.name]: item.content})
     ...
     return (
        <div className="wrapper">
            <DisplayAHnnyAppTable data = {data.pointDistribution.edges} fields={{id:'pointsId'}}/>
