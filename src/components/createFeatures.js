	...
	return (
		<div className={classes.featureContainer}>
			<div>
				<Button
					id="text"
					className={classes.features + " features-hover"}
					onClick={(e) => {
						handleSelectedFeature(e, "text");
					}}
				>
					text
				</Button>
				...
				<Button
					...
					className={classes.features + " features-hover"}
					onClick={(e) => {
						handleSelectedFeature(e, "gallery");
					}}
				>
					gallery
				</Button>
