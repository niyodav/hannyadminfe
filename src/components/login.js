...
function Login() {
    ...
    return (
        <div style={{position:"relative", paddingTop:"20%",paddingLeft:"40%",background:'#ff8000',height:"700px"}}>
            ...
            InputProps={{ style: {fontFamily:"NanumSquare",background:'#fff'} }} 
            ...
            <div style={{marginTop:10}} >
                 <Button
                  style= {{background:'#009E09',width:190}}
                 >Log in</Button>
            </div>
