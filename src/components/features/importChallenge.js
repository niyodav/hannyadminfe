...
function submitForm(contentType, data, setResponse) {
    ...
    return (
        <div>
            <form>  
                 <div   style={{ backgroundColor: '#ff8000',cursor:"poi nter", width: 100,height:40,paddingTop:20,  textAlign: 'center' ,    borderRadius:12,border:"1px solid #FFF",fontSize:12,display:img?'none':"block"}} onClick={(e)=>{setShowUpload("block")}} >
                    <input type="file" id="upload" hidden style={{display:"none"}}  onChange={handleFiles}/>
                    <label for="upload" style={{cursor:"pointer"}}>Import Challenge</label>
                    <div>      
                    </div>
                </div> 
